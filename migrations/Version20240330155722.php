 ...
 */
final class Version20240330155722 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video ADD CONSTRAINT FK_7CC7DA2CBCD8F00E FOREIGN KEY (playlist2_id) REFERENCES playlist (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
